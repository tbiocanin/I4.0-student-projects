function [nova_mat_kov] = kalmanFilterPredikcija(prethodni_polozaj, prethodna_mat_kov, delta_s_desno, delta_s_levo, b)
    
      teta_nula = prethodni_polozaj(3, 1);
      r = 2.5;
  
      delta_s_desno = delta_s_desno * pi * r / 180;
      delta_s_levo = delta_s_levo * pi * r / 180;
