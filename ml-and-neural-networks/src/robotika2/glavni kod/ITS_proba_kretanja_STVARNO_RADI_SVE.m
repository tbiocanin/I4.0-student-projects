...
mymotor1 = motor(myev3, 'B'); % Set up motor
...
%     mapa1 = [25 22; 55 29.5; 62.5 57; 15 68; 31 90; 64 102];%!
    ...
    for k = 1 : sizpath
        ...
        if abs(fi_steer) >= 15 % Podeisiti toleraciju rotacije
            ...
            [x,C] = model_kretanja_grupa4(x, C, dsr, dsl, b, M); % dodati svoj model kretanja
...
%             'Go str8'
            ...
            [x,C] = odometry_prediction_NEW(x, C, dsr, dsl, b, M);% dodati svoj model kretanja
