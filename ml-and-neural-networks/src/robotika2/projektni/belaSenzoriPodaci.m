...
for i=1:100
    bela(1, i)=readLightIntensity(mycolorsensor, 'reflected');
    %pause(0.2)
end 
...
for i=1:100
    bela(2, i)=readLightIntensity(mycolorsensor, 'reflected');
    %pause(0.2)
end
...
%bela boja, nijanse
for i=1:100
    bela(3, i)=readLightIntensity(mycolorsensor, 'reflected');
    %pause(0.2)
end
...
%crna-like boja, nijanse
for i=1:100
    bela(4, i)=readLightIntensity(mycolorsensor, 'reflected');
    %pause(0.2)
end
...
start(mymotor2);
for i=1:100
    bela(5, i)=readLightIntensity(mycolorsensor, 'reflected');
    %pause(0.2)
end
stop(mymotor1, 0);
stop(mymotor2, 0);
